...
* In the interactive manhattan and qq plots below, we only use a subset (chromosomes 4 to 7) of the `HapMap` data included in this package. A more complete version of this vignette can be found at http://sahirbhatnagar.com/manhattanly/
